...
class MenuScene(Scene):
    def __init__(self, game):
        ...
        self.font_title = pygame.font.Font("assets/fonts/StarCrush.ttf", 96)
        self.font_input = pygame.font.Font("assets/fonts/StarCrush.ttf", 36)
        self.font_button = pygame.font.Font("assets/fonts/StarCrush.ttf", 30)
        ...
        self.input_rect = pygame.Rect(0, 0, 400, 50)
        self.input_rect.center = relative_to_pixel((0.5, 0.4))
        self.input_text = ""
        self.input_active = False

        self.button_rect = pygame.Rect(0, 0, 260, 60)
    ...
    def update(self, dt):         # Change cursor to pointer when hovering over button
    ...
    def render(self, screen):
        ...
        if self.lobby_message == "":
            ...
            text_y = self.input_rect.y + (self.input_rect.height - input_surf.get_height()) // 2
            screen.blit(input_surf, (self.input_rect.x + 8, text_y))

            pygame.draw.rect(screen, (95, 222, 130), self.button_rect, border_radius = 8)    #, border_radius=8
